...
class TaxiBenchmark(Benchmark):
    ...
    def run(self, **kwargs):
        ...
        gen = TaxiGenerator(self._datafile, self._reuse, self._parallel)
...
class CensusBenchmark(Benchmark):
    ...
    def run(self, **kwargs):
        ...
        gen = CensusGenerator(self._datafile, self._reuse, self._parallel)
        gen.generate(self._records)
...
class PlasticcBenchmark(Benchmark):
    ...
    def run(self):
        ...
        gen = PlasticcGenerator(self._datafile_prefix, self._reuse, self._parallel)
        output_files = list(
            gen.generate(
